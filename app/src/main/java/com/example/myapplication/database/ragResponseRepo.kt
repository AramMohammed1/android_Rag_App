...
interface RagResponseRepo {
    suspend fun postQuestion(fileNames:List<String>,question:String,chunks:Int,numofresults:Int ):ChatResponse
...
class NetworkRagRepository(private val apiService:RagApiService):RagResponseRepo{
    ...
    override suspend fun postQuestion(fileNames:List<String>,question:String,chunks:Int,numofresults:Int): ChatResponse {
